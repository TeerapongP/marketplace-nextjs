...
const ProductEditPage = () => {
  ...
  }, [productId, token, categoryId, shopId, pathname]); // Correct the dependency list
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await fetch('/api/products/product-create', {
        method: 'PATCH',
        headers: {
      ...
      router.push('/');
      setAlertMessage('Product create successfully!');
